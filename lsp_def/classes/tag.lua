...
---@field check_duplicate_register? fun(self: table|SMODS.Tag): boolean? Ensures objects already registered will not register. 
...
---@field get_obj? fun(self: table|SMODS.Tag, key: string): table? Returns an object if one matches the `key`. 
...
---@field in_pool? fun(self: table|SMODS.Tag, args: table): nil|boolean, table? Allows configuring if the tag is allowed to spawn. 
