...
---@field send_to_subclasses? fun(self: table|SMODS.Joker, ...: any): string Starting from this class, recusively searches for functions with the given key on all subordinate classes and run all found functions with the given arguments. 
...
---@field inject? fun(self: table|SMODS.Joker) Called during `inject_class`. Injects the object into the game. 
---@field take_ownership? fun(self: table|SMODS.Joker, key: string, obj: table, silent?: boolean): SMODS.Joker Takes control of vanilla objects. Child class must have get_obj for this to function
---@field get_obj? fun(self: table|SMODS.Joker, key: string): table|nil Returns an object if one matches the `key`. 
---@field calc_dollar_bonus? fun(self: table|SMODS.Joker, card: Card): nil|number Calculates reward money. 
