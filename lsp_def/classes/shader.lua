...
---@field __call? fun(self: SMODS.Shader|table, o: SMODS.Shader|table): nil|SMODS.Shader
...
---@field check_duplicate_key? fun(self: SMODS.Shader|table): boolean? Ensures objects with duplicate keys will not register. Checked on __call but not take_ownerhsip. For take_ownership, the key must exist. 
---@field register? fun(self: SMODS.Shader|table) Registers the object. 
---@field check_dependencies? fun(self: SMODS.Shader|table): boolean? Returns true if there's no failed dependencies, else false
---@field process_loc_text? fun(self: SMODS.Shader|table) Called during `inject_class`. Handles injecting loc_text. 
---@field send_to_subclasses? fun(self: SMODS.Shader|table, func: function, ...: any) Starting from this class, recusively searches for functions with the given key on all subordinate classes and run all found functions with the given arguments. 
...
---@field take_ownership? fun(self: SMODS.Shader|table, key: string, obj: table, silent?: boolean): nil|SMODS.Shader Takes control of vanilla objects. Child class must have get_obj for this to function
---@field get_obj? fun(self: SMODS.Shader|table, key: string): table? Returns an object if one matches the `key`. 
