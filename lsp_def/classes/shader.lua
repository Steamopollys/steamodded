...
---@field __call? fun(self: table, o: SMODS.Shader): SMODS.Shader
---@field extend? fun(self: table, o: SMODS.Shader): table Primary method of creating a class. 
---@field check_duplicate_register? fun(self: table, o: SMODS.Shader): table
