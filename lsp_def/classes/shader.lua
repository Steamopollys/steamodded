...
---@field check_duplicate_register? fun(self: table|SMODS.Shader): boolean? Ensures objects already registered will not register. 
...
---@field inject? fun(self: table|SMODS.Shader, i?: number) Called during `inject_class`. Injects the object into the game. 
---@field take_ownership? fun(self: table|SMODS.Shader, key: string, obj: table, silent?: boolean): nil|SMODS.Shader Takes control of vanilla objects. Child class must have get_obj for this to function
---@field get_obj? fun(self: table|SMODS.Shader, key: string): table? Returns an object if one matches the `key`. 
