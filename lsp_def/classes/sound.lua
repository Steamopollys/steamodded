...
---@field check_duplicate_register? fun(self: table|SMODS.Sound): boolean? Ensures objects already registered will not register. 
...
---@field get_obj? fun(self: table|SMODS.Sound, key: string): table? Returns an object if one matches the `key`. 
