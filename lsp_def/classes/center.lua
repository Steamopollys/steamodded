...
---@field check_duplicate_register? fun(self: table|SMODS.Center): boolean? Ensures objects already registered will not register. 
...
---@field get_obj? fun(self: table|SMODS.Center, key: string): table? Returns an object if one matches the `key`. 
...
---@field check_for_unlock? fun(self: table|SMODS.Center, args: table): boolean? Configures unlock conditions. See vanilla implementation of `check_for_unlock` for details on `args` parameters. 
...
---@field calculate? fun(self: table|SMODS.Center, card: table|Card, context: table): nil|table?, boolean?  Calculates effects based on parameters in `context`. See SMODS calculations docs for details. 
