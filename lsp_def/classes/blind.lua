...
---@field __call? fun(self: table|SMODS.Blind, o: SMODS.Blind): SMODS.Blind
---@field extend? fun(self: table|SMODS.Blind, o: SMODS.Blind): table Primary method of creating a class. 
---@field check_duplicate_register? fun(self: table|SMODS.Blind, o: SMODS.Blind): table
...
---@field send_to_subclasses? fun(self: table|SMODS.Blind, ...: any): string Starting from this class, recusively searches for functions with the given key on all subordinate classes and run all found functions with the given arguments. 
