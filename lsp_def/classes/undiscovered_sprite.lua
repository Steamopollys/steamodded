...
---@field check_duplicate_register? fun(self: table|SMODS.UndiscoveredSprite): boolean? Ensures objects already registered will not register. 
...
---@field get_obj? fun(self: table|SMODS.UndiscoveredSprite, key: string): table? Returns an object if one matches the `key`. 
