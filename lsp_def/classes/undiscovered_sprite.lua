...
---@field __call? fun(self: table, o: SMODS.UndiscoveredSprite): SMODS.UndiscoveredSprite
---@field extend? fun(self: table, o: SMODS.UndiscoveredSprite): table Primary method of creating a class. 
---@field check_duplicate_register? fun(self: table, o: SMODS.UndiscoveredSprite): table
