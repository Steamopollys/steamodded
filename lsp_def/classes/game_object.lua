...
---@field check_duplicate_register? fun(self: table|SMODS.GameObject): boolean? Ensures objects already registered will not register. 
...
---@field get_obj? fun(self: table|SMODS.GameObject, key: string): table? Returns an object if one matches the `key`. 
