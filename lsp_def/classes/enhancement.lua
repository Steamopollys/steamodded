...
---@field send_to_subclasses? fun(self: table|SMODS.Enhancement, ...: any): string Starting from this class, recusively searches for functions with the given key on all subordinate classes and run all found functions with the given arguments. 
...
---@field inject? fun(self: table|SMODS.Enhancement) Called during `inject_class`. Injects the object into the game. 
---@field take_ownership? fun(self: table|SMODS.Enhancement, key: string, obj: table, silent?: boolean): SMODS.Enhancement Takes control of vanilla objects. Child class must have get_obj for this to function
---@field get_obj? fun(self: table|SMODS.Enhancement, key: string): table|nil Returns an object if one matches the `key`. 
