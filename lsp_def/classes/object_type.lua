...
---@field __call? fun(self: table, o: SMODS.ObjectType): SMODS.ObjectType
---@field extend? fun(self: table, o: SMODS.ObjectType): table Primary method of creating a class. 
---@field check_duplicate_register? fun(self: table, o: SMODS.ObjectType): table
...
---@field take_ownership? fun(self: table, key: string, obj: table, silent?: boolean): SMODS.ObjectType Takes control of vanilla objects. Child class must have get_obj for this to function
---@field get_obj? fun(self: table, key: string): table|nil Returns an object if one matches the `key`. 
---@field inject_card? fun(self: table, center: table) Injects the center into the ObjectType pools.
---@field remove_card? fun(self: table, center: table) Removes the center from ObjectType pools. 
---@overload fun(self: table): SMODS.ObjectType
