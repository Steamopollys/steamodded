...
---@field check_duplicate_register? fun(self: table|SMODS.Sticker): nil|boolean?Ensures objects already registered will not register. 
---@field check_duplicate_key? fun(self: table|SMODS.Sticker): nil|boolean?Ensures objects with duplicate keys will not register. Checked on __call but not take_ownerhsip. For take_ownership, the key must exist. 
---@field register? fun(self: table|SMODS.Sticker) Registers the object. 
---@field check_dependencies? fun(self: table|SMODS.Sticker): nil|boolean?Returns true if there's no failed dependencies, else false
...
---@field calculate? fun(self: table|SMODS.Sticker, card: table|Card, context: table): nil|table?, nil|boolean? Calculates effects based on parameters in `context`. See SMODS calculations docs for details. 
