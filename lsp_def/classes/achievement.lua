...
---@field __call? fun(self: table|SMODS.Achievement, o: SMODS.Achievement): SMODS.Achievement
---@field extend? fun(self: table|SMODS.Achievement, o: SMODS.Achievement): table Primary method of creating a class. 
---@field check_duplicate_register? fun(self: table|SMODS.Achievement, o: SMODS.Achievement): table
...
---@field send_to_subclasses? fun(self: table|SMODS.Achievement, ...: any): string Starting from this class, recusively searches for functions with the given key on all subordinate classes and run all found functions with the given arguments. 
...
---@field post_inject_class? fun(self: table|SMODS.Achievement) Called after `inject_class`. Injects and manages class information after object injection. 
...
---@field inject? fun(self: table|SMODS.Achievement) Called during `inject_class`. Injects the object into the game. 
---@field take_ownership? fun(self: table|SMODS.Achievement, key: string, obj: table, silent?: boolean): SMODS.Achievement Takes control of vanilla objects. Child class must have get_obj for this to function
