...
---@field __call? fun(self: table|SMODS.PokerHand, o: SMODS.PokerHand): SMODS.PokerHand
---@field extend? fun(self: table|SMODS.PokerHand, o: SMODS.PokerHand): table Primary method of creating a class. 
---@field check_duplicate_register? fun(self: table|SMODS.PokerHand, o: SMODS.PokerHand): table
...
---@field send_to_subclasses? fun(self: table|SMODS.PokerHand, ...: any): string Starting from this class, recusively searches for functions with the given key on all subordinate classes and run all found functions with the given arguments. 
...
---@field inject? fun(self: table|SMODS.PokerHand) Called during `inject_class`. Injects the object into the game. 
---@field take_ownership? fun(self: table|SMODS.PokerHand, key: string, obj: table, silent?: boolean): SMODS.PokerHand Takes control of vanilla objects. Child class must have get_obj for this to function
...
---@field __call? fun(self: table|SMODS.PokerHandPart, o: SMODS.PokerHandPart): SMODS.PokerHandPart
---@field extend? fun(self: table|SMODS.PokerHandPart, o: SMODS.PokerHandPart): table Primary method of creating a class. 
---@field check_duplicate_register? fun(self: table|SMODS.PokerHandPart, o: SMODS.PokerHandPart): table
...
---@field send_to_subclasses? fun(self: table|SMODS.PokerHandPart, ...: any): string Starting from this class, recusively searches for functions with the given key on all subordinate classes and run all found functions with the given arguments. 
...
---@field inject? fun(self: table|SMODS.PokerHandPart) Called during `inject_class`. Injects the object into the game. 
---@field take_ownership? fun(self: table|SMODS.PokerHandPart, key: string, obj: table, silent?: boolean): SMODS.PokerHandPart Takes control of vanilla objects. Child class must have get_obj for this to function
