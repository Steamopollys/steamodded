...
---@field take_ownership? fun(self: table, key: string, obj: table, silent?: boolean): SMODS.Booster Takes control of vanilla objects. Child class must have get_obj for this to function
---@field get_obj? fun(self: table, key: string): table|nil Returns an object if one matches the `key`. 
---@field create_card? fun(self: table, card: Card, i: number): table|Card Creates the cards inside the booster pack. Returning a table will create a Card through `SMODS.create_card`. 
---@field update_pack? fun(self: table, dt: number) Handles booster pack UI when opened. 
---@field ease_background_colour? fun(self: table) Changes background colour when booster pack is opened. 
