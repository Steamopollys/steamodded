...
---@field __call? fun(self: table|SMODS.Keybind, o: table|SMODS.Keybind): nil|SMODS.Keybind
---@field extend? fun(self: table|SMODS.Keybind, o: table|SMODS.Keybind): table Primary method of creating a class. 
---@field check_duplicate_register? fun(self: table|SMODS.Keybind): nil|boolean?Ensures objects already registered will not register. 
---@field check_duplicate_key? fun(self: table|SMODS.Keybind): nil|boolean?Ensures objects with duplicate keys will not register. Checked on __call but not take_ownerhsip. For take_ownership, the key must exist. 
---@field register? fun(self: table|SMODS.Keybind) Registers the object. 
---@field check_dependencies? fun(self: table|SMODS.Keybind): nil|boolean?Returns true if there's no failed dependencies, else false
---@field process_loc_text? fun(self: table|SMODS.Keybind) Called during `inject_class`. Handles injecting loc_text. 
---@field send_to_subclasses? fun(self: table|SMODS.Keybind, ...: any) Starting from this class, recusively searches for functions with the given key on all subordinate classes and run all found functions with the given arguments. 
...
---@field inject? fun(self: table|SMODS.Keybind, i?: number) Called during `inject_class`. Injects the object into the game. 
---@field take_ownership? fun(self: table|SMODS.Keybind, key: string, obj: table, silent?: boolean): nil|SMODS.Keybind Takes control of vanilla objects. Child class must have get_obj for this to function
