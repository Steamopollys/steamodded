...
---@field __call? fun(self: table|SMODS.Language, o: table|SMODS.Language): nil|SMODS.Language
---@field extend? fun(self: table|SMODS.Language, o: table|SMODS.Language): table Primary method of creating a class. 
---@field check_duplicate_register? fun(self: table|SMODS.Language): boolean? Ensures objects already registered will not register. 
...
---@field inject? fun(self: table|SMODS.Language, i?: number) Called during `inject_class`. Injects the object into the game. 
---@field take_ownership? fun(self: table|SMODS.Language, key: string, obj: table, silent?: boolean): nil|SMODS.Language Takes control of vanilla objects. Child class must have get_obj for this to function
---@field get_obj? fun(self: table|SMODS.Language, key: string): table? Returns an object if one matches the `key`. 
