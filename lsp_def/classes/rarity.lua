...
---@field __call? fun(self: table, o: SMODS.Rarity): SMODS.Rarity
---@field extend? fun(self: table, o: SMODS.Rarity): table Primary method of creating a class. 
---@field check_duplicate_register? fun(self: table, o: SMODS.Rarity): table
...
---@field take_ownership? fun(self: table, key: string, obj: table, silent?: boolean): SMODS.Rarity Takes control of vanilla objects. Child class must have get_obj for this to function
